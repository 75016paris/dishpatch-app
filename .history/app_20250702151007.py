...
if uploaded_file:
    ...
    col2.metric("Average renewals per week (all time) :", f"{renewal_flow_results['avg_renewals_per_week']:.1f}")
    ...
    col1, col2, col3 = st.columns(3)
    col1.metric("Avg. Post-Renewal Churn per week (all time) :", f"{renewal_flow_results['avg_post_churn_per_week']:.1f}")
