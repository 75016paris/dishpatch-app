...
if uploaded_file:
    ...
    col1, col2, col3 = st.columns(3)
    col1.metric("Post-Renewal Churn (last 8 weeks) :", f"{renewal_metrics_8w['churn_post_renewal']}")
    col2.metric("Refund Churn (last 8 weeks) :", f"{renewal_metrics_8w['churn_refund_renewal']}")
