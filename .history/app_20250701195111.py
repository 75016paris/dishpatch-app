...
if uploaded_file:
    ...
    col1.metric("Max conversions week:", f"{trials_metrics_all['max_week']} - ({trials_metrics_all['max_week_label'])}")
    col2.metric("Max conversions week:", f"{trials_metrics_all['min_week']} - ({trials_metrics_all['min_week_label'])}")
