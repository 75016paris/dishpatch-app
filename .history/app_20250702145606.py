...
if uploaded_file:
    ...
    col2.metric("Recent trials average (last 4 weeks) :", f"{trials_metrics_8w['recent_4w_avg']:.0f}")
    ...
    col1.metric(f"Max trials week (last 8 weeks) : *{trials_metrics_8w['max_week_label']}*", f"{trials_metrics_8w['max_week']}")
    ...
    col2.metric("Recent weeks trials average (4 weeks) :", f"{trials_metrics_8w['recent_4w_avg']:.0f}")

    col1, col2 = st.columns(2)
    col1.metric(f"Max trials week (all time) : *{trials_metrics_all['max_week_label']}*", f"{trials_metrics_all['max_week']}")
