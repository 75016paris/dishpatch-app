...
if uploaded_file:
    ...
    col1, col2 = st.columns(2)
    col1.metric(f"Max conversions week : *{metrics_8w['max_conv_label']}*", f"{metrics_8w['max_conv_value']}")
    col2.metric(f"Min conversions week : *{metrics_8w['min_conv_label']}*", f"{metrics_8w['min_conv_value']}")
