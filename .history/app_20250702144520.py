...
if uploaded_file:
    ...
    col1, col2 = st.columns(2)
    col1.metric("Total renewals (last 8 weeks) :", f"{renewal_flow_results['total_renewals']}")
    col2.metric("Total churn (last 8 weeks) :", f"{renewal_flow_results['total_churn']}")

    col1, col2 = st.columns(2)
    col1.metric("Post-Renewal Churn (last 8 weeks) :", f"{renewal_flow_results['total_churn_post_renewal']}")
    col2.metric("Refund Churn (last 8 weeks) :", f"{renewal_flow_results['total_churn_refund_renewal']}")
