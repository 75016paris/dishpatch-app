...
if uploaded_file:
    ...
    st.markdown(f"*Active Full Member in 1st year :* **{renewal_dict['active_in_y1']}** *Active Full Member in 2nd year :* **{renewal_dict['renewal_rate_y2_to_y3']}% - {renewal_dict['refund_rate_y3']}%** *ask for refund*")
