...
if uploaded_file:
    ...
    col2.metric("Average per week (all time):", f"{trials_metrics_all['average_per_week']:.0f}")
    col3.metric("Recent 4-week average (all time):", f"{trials_metrics_8w['recent_4w_avg']:.0f}")
