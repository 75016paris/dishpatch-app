...
if uploaded_file:
    ...
    col3.metric("Refund Churn (last 8 weeks) :", f"{renewal_metrics_8w['churn_refund_renewal']}")
    ...
    col3.metric("Refund Churn (all times) :", f"{renewal_flow_results['total_churn_refund_renewal']}")
    ...
    col3.metric("Drop-off during refund:", f"{last_cohort_dict['drop_off_refund']:.1f}%")
