...
if uploaded_file:
    ...
    col1, col2 = st.columns(2)
    col1.metric("Max conversions:", f"{metrics_8w['max_conv_week']} - ({metrics_8w['max_conv_label']})")
    col1.metric("Min conversions:", f"{metrics_8w['min_conv_week']} - ({metrics_8w['min_conv_label']})")
