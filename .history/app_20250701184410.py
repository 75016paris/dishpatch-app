...
from DISHPATCH import plot_weekly_trials_8_weeks,
import matplotlib
matplotlib.use('Agg')
...
if uploaded_file:
    ...
    fig_trials_metrics_8w, trials_metrics_8w = plot_weekly_trials_8_weeks(sub_df, today_date, today_iso, num_weeks=8)
