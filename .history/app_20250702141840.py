...
if uploaded_file:
    ...
    col1, col2, col3 = st.columns(3)
    col1.metric("New trial last week:", value=f"{new_trial_last_week['trials_count']}", delta=f"{new_trial_last_week['trials_count'] - new_trial_prev_week['trials_count']:+d}")
    col2.metric("New full member last week:", value=f"{last_week_new_full_member['count']}", delta=f"{last_week_new_full_member['count'] - prev_week_new_full_member['count']:+d}")
    col3.metric("Churn full member last week:", value=f"{last_week_churned_members['count']}", delta=f"{last_week_churned_members['count'] - prev_week_churned_members['count']:+d}", delta_color='inverse')
    ...
    col1, col2 = st.columns(2)
    col1.metric("Max trials week (8 weeks) :", f"{trials_metrics_8w['max_week']}")
    col1.markdown(f"({trials_metrics_8w['max_week_label']})")
    col2.metric("Min trials week (8 weeks) : ", f"{trials_metrics_8w['min_week']}")
    col2.markdown(f"({trials_metrics_8w['min_week_label']})")
    ...
    col1, col2 = st.columns(2)
    col1.metric("Max trials week (all time) :", f"{trials_metrics_all['max_week']} - ({trials_metrics_all['max_week_label']})")
    col2.metric("Min trials week (all time) :", f"{trials_metrics_all['min_week']} - ({trials_metrics_all['min_week_label']})")
