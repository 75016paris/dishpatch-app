...
fait les touse en .get, ou 0


Code avec accès sécurisé aux dictionnaires
Code
Voilà ! Maintenant ton code est sécurisé. Même si last_cohort_dict est un dictionnaire vide {}, toutes ces variables auront la valeur 0 au lieu de provoquer une erreur.
