...
if uploaded_file:
    ...
    col1.metric("Average trials per week (8 weeks) :", f"{trials_metrics_8w['average_per_week']:.0f}")
    col2.metric("Recent trials average (4 weeks) :", f"{trials_metrics_8w['recent_4w_avg']:.0f}")

    col1, col2 = st.columns(2)
    col1.metric(f"Max trials week (8 weeks) : *{trials_metrics_8w['max_week_label']}*", f"{trials_metrics_8w['max_week']}")
    col2.metric(f"Min trials week (8 weeks) : *{trials_metrics_8w['min_week_label']}*", f"{trials_metrics_8w['min_week']}")
    ...
    st.metric("Total trials (all time) :", f"{trials_metrics_all['total_trials']:.0f}")

    col1, col2 = st.columns(2)
    col2.metric("Average trials per week (all time) :", f"{trials_metrics_all['average_per_week']:.0f}")
    col3.metric("Recent weeks trials average (4 weeks) :", f"{trials_metrics_8w['recent_4w_avg']:.0f}")
