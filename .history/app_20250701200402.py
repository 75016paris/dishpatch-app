...
if uploaded_file:
    ...
    col2.metric("Average churn per week (all time):", f"{weekly_flow_all_time_result['avg_net_per_week']:.1f}")
    col3.metric("Net growth average (all time):", f"{weekly_flow_all_time_result['net_growth']}")
