...
if uploaded_file:
    ...
    col1, col2 = st.columns(2)
    col1.metric("Max week::", f"{trials_metrics_all['max_week']} - ({trials_metrics_all['max_week_label'])}")
    col2.metric("Min week::", f"{trials_metrics_all['min_week']} - ({trials_metrics_all['min_week_label'])}")
    ...
    col1, col2 = st.columns(2)
    col1.metric("Average conversions per week (8 weeks):", f"{trials_metrics_all['max_week']} - ({trials_metrics_all['max_week_label'])}")
    col2.metric("Min week::", f"{trials_metrics_all['min_week']} - ({trials_metrics_all['min_week_label'])}")
