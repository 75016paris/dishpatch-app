...
if uploaded_file:
    ...
    col1, col2, col3 = st.columns(3)
    col1.metric("Total Renewls Churn (last 8 weeks) :", f"{renewal_metrics_8w['total_churn']}")
    ...
    col2.metric("Total churn (all times):", f"{renewal_flow_results['total_churn']}")

    col1, col2 = st.columns(2)
    col1.metric("Post-Renewal Churn (all times):", f"{renewal_flow_results['total_churn_post_renewal']}")
    col2.metric("Refund Churn (all times):", f"{renewal_flow_results['total_churn_refund_renewal']}")
