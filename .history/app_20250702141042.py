...
if uploaded_file:
    ...
    col1, col2, col3 = st.columns(3)
    col1.metric("New trial last week:", value=f"{new_trial_last_week['trials_count']}", delta=f"{new_trial_prev_week['trials_count']}")
    col2.metric("New full member last week:", value=f"{last_week_new_full_member['count']}", delta=f"{prev_week_new_full_member['count']}")
    col3.metric("Churn full member last week:", value=f"{last_week_churned_members['count']}", delta=f"{prev_week_churned_members['count']}, delta_color="reverse")
