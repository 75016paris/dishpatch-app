...
if uploaded_file:
    ...
    col1, col2 = st.columns(2)
    col1.metric(f"Max conversions week : *{weekly_flow_all_time_result['max_conv_label']}*", f"{weekly_flow_all_time_result['max_conv_value']}")
    col2.metric(f"Min conversions week : *{weekly_flow_all_time_result['min_conv_label']}*", f"{weekly_flow_all_time_result['min_conv_value']}")
