...
if uploaded_file:
    ...
    col1, col2, col3 = st.columns(3)
    col1.metric("Average conversions per week (last 8 weeks) :", f"{metrics_8w['avg_conversions_per_week']:.1f}")
    col2.metric("Average churn per week (last 8 weeks) :", f"{metrics_8w['avg_churn_per_week']:.1f}")
