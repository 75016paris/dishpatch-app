...
if uploaded_file:
    ...
    col1.metric("Average trial per week:", f"{trials_metrics_8w['average_per_week']:.0f}")
    col2.metric("Recent 4-week trial average:", f"{trials_metrics_8w['recent_4w_avg']:.0f}")

    col1, col2 = st.columns(2)
    col1.metric("Max Trial per week (8 week):", f"{trials_metrics_8w['max_week']} - ({trials_metrics_8w['max_week_label']})")
